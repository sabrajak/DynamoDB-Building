...
public class DynamoController {
	...
	@GetMapping({"/getByRangeDateAndTime/{startDate}/{endDate}", "/getByRangeDateAndTime/{startDate}/{endDate}/{startTime}/{endTime}"})
	public List<SchemaMigrationAudit> getByRangeDateAndTime(@PathVariable String startDate,
			@PathVariable String endDate, @PathVariable(required = false) String startTime, @PathVariable(required = false) String endTime) {
